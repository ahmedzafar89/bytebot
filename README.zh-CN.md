...
<p align="center">
  <a href="https://useanything.com"><img src="https://github.com/Mintplex-Labs/anything-llm/blob/master/images/wordmark.png?raw=true" alt="ByteBot logo"></a>
</p>

<p align="center">
    <b>ByteBot：</b> 您一直在寻找的全方位AI应用程序。<br />
...
<p align="center">
👉 适用于桌面（Mac、Windows和Linux）的ByteBot！<a href="https://useanything.com/download" target="_blank">立即下载</a>
</p>
...
ByteBot是一个全栈应用程序，您可以使用现成的商业大语言模型或流行的开源大语言模型，再结合向量数据库解决方案构建一个私有ChatGPT，不再受制于人：您可以本地运行，也可以远程托管，并能够与您提供的任何文档智能聊天。

ByteBot将您的文档划分为称为`workspaces` (工作区)的对象。工作区的功能类似于线程，同时增加了文档的容器化，。工作区可以共享文档，但工作区之间的内容不会互相干扰或污染，因此您可以保持每个工作区的上下文清晰。
...
- [ByteBot原生嵌入器](/server/storage/models/README.md)（默认）
- [OpenAI](https://openai.com)
- [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service)
...
- [ByteBot内置](https://github.com/Mintplex-Labs/anything-llm/tree/master/server/storage/models#audiovideo-transcription) （默认）
- [OpenAI](https://openai.com/)
...
Mintplex Labs和社区维护了许多部署方法、脚本和模板，您可以使用它们在本地运行ByteBot。请参阅下面的表格，了解如何在您喜欢的环境上部署，或自动部署。
...
[其他方案：不使用Docker配置ByteBot实例 →](./BARE_METAL.md)
...
由Mintplex Labs Inc开发的ByteBot包含一个收集匿名使用信息的Telemetry功能。

<details>
<summary><kbd>有关ByteBot的远程信息收集与隐私保护更多信息</kbd></summary>
...
我们使用这些信息来帮助我们理解ByteBot的使用情况，帮助我们确定新功能和错误修复的优先级，并帮助我们提高ByteBot的性能和稳定性。

### 怎样关闭

通过在服务器或docker的.env设置中将`DISABLE_TELEMETRY`设置为“true”来选择退出Telemetry远程信息收集功能。您也可以进入ByteBot应用>>>侧边栏最下方 >>> `隐私和数据` （Privacy&Data)>>>找到最下方的Anonymous Telemetry Enabled，点击绿色按钮让它变灰色，从而禁用信息收集功能。
