...
export default function DefaultChatContainer() {
  ...
  const popMsg = !window.localStorage.getItem("bytebot_intro");
      ...
      >
        ...
        >
          <div className="flex gap-x-5">
            ...
            >
              Welcome to ByteBot. <br />
              Your all-in-one AI companion for seamless interaction with your documents. <br /> 
              Summarize long documents, explain complex concepts, and find key information in seconds and increase productivity by 100x. 
            </span>
          </div>
        </div>
      </div>
  ...
  useEffect(() => {
    function processMsgs() {
      if (!!window.localStorage.getItem("bytebot_intro")) {
      ...
      window.localStorage.setItem("bytebot_intro", 1);
    }
