...
const doc = {
  info: {
    version: '1.0.0',
    title: 'ByteBot Developer API',
    description: 'API endpoints that enable programmatic reading, writing, and updating of your ByteBot instance. UI supplied by Swagger.io.',
  },
